...
// implements Node.
func literal(s parser.State, pow int, tok *lexer.Token) (common.Node, error) {
...
func Prefix(factory func(s parser.State, op *lexer.Token, exp common.Node) (common.Node, error), power int) parser.ExprFirst {
	return func(s parser.State, pow int, tok *lexer.Token) (common.Node, error) {
...
// operator.
func Infix(factory func(s parser.State, l, r common.Node, op *lexer.Token) (common.Node, error)) parser.ExprNext {
	return func(s parser.State, pow int, l common.Node, tok *lexer.Token) (common.Node, error) {
		// Get the sub-expression on the right
...
// called with the left and right nodes and the token representing the
// operator.
func InfixR(factory func(s parser.State, l, r common.Node, op *lexer.Token) (common.Node, error)) parser.ExprNext {
	return func(s parser.State, pow int, l common.Node, tok *lexer.Token) (common.Node, error) {
		// Get the sub-expression on the right
