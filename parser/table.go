...
type ExprFirst func(state State, power int, tok *lexer.Token) (Node, error)
...
type ExprNext func(state State, power int, left Node, tok *lexer.Token) (Node, error)
...
// additional tokens.
type Statement func(state State, tok *lexer.Token) (Node, error)
...
func (e Entry) callFirst(s State, tok *lexer.Token) (Node, error) {
	if e.First == nil {
...
func (e Entry) callNext(s State, l Node, tok *lexer.Token) (Node, error) {
	if e.Next == nil {
		return nil, UnexpectedToken(tok)
	}
...
func (e Entry) callStmt(s State, tok *lexer.Token) (Node, error) {
	if e.Stmt == nil {
		return nil, UnexpectedToken(tok)
	}
